...
const Learn = () => (
  <div className='bg-gradient-to-r from-slate-900 to-sky-300 pb-16 lg:relative lg:z-10 lg:pb-0'>
    <div className='lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8'>
      <div className='relative lg:-my-8'>
        ...
        />
        <div className='mx-auto max-w-md p-4 sm:max-w-5xl lg:h-full lg:p-0'>
          <div className='aspect-w-12 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full'>
            <Image
          ...
          <blockquote>
            <div>
              ...
              <p className='mt-6 text-xl font-medium text-white'>
                ...
                are a seasoned pro, our community is designed to help you grow.
                <br />
                <br />
                Join us for a variety of tech talks, workshops, challenges, and
                more. Our engaging events cater to both beginners and advanced
                learners, empowering you to build your first website or advance
                your cloud deployment skills. With hands-on learning and a
                supportive community, {"it's"} never been easier to level up
                your tech career.
              </p>
            </div>
          </blockquote>
